...
// void myDisplay(char * txt, int sec) {
//   long startTime;
//     startTime = millis();  
...
//   for(int i = 0; i < 9; i++){
//     while((millis() - startTime)/1000 <= sec) {
//     switch(i){
//       case 0: 
//          {
//           displayNumber("000" + txt[0]);
//         }
//         break;
//       case 1:
//         displayNumber("00" + txt[0] + txt[1]);
//         break;
//       case 2:
//         displayNumber("0" + txt[0] + txt[1] + txt[2] );
//         break;
//       case 3:
//         displayNumber(txt[0] + txt[1] + txt[2] + txt[3]);
//         break;
//       case 4:
//         displayNumber(txt[1] + txt[2] + txt[3] + txt[4]);
//         break;    
//       case 5:
//         displayNumber(txt[2] + txt[3] + txt[4] + txt[5]);
//         break;
//       case 6:
//         displayNumber(txt[3] + txt[4] + txt[5] + "0");
//         break; 
//       case 7:
//         displayNumber(txt[4] + txt[5] + "00");
//         break;   
//       case 8:
//         displayNumber(txt[5] +"000");
//         break; 
//     }
//   }
//   }
